...
import { sortByNameFavorites, sortByPriceFavorites, filterByCategoryFavorites } from "../../redux/actions/favorites";
                    ...
                    {Array.isArray(favorites) && favorites?.length > 0 ?
                        <>
                            <Grid container direction="row" justifyContent="center">
                                <Typography variant='h6' style={{marginTop:'3vh', marginBottom:'3vh'}}>Mis Favoritos!</Typography>
                            </Grid>
